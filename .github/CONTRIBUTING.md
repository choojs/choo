...
contributions are encouraged and valued. See below for different ways to help,
...
The [Project Team](#join-the-project-team) looks forward to your
contributions.~
...
- Open an Issue at https://github.com/choojs/choo/issues
...
- If you or the maintainers don't respond to an issue for 30 days, the [issue
  will be closed](#clean-up-issues-and-prs). If you want to come back to it,
  reply (once, please), and we'll reopen the existing issue. Please avoid
...
and file a PR](https://guides.github.com/activities/forking) if you've never
done it before.
...
- Go to https://github.com/choojs/choo/pulls and open a new pull request with
  your changes.
...
- Go to the issue tracker and [filter open
  issues](https://github.com/choojs/choo/issues?q=is%3Aopen+is%3Aissue).
...
- Be kind and patient with users -- often, folks who have run into confusing
  ...
  hostile or is violating the CoC, [refer to the Code of
  Conduct](CODE_OF_CONDUCT.md) to resolve the conflict).
...
In order to label issues, [open up the list of unlabeled
issues](https://github.com/choojs/choo/issues?q=is%3Aopen+is%3Aissue+no%3Alabel)
and, __from newest to oldest__, read through each one and apply issue labels
...
- Go through each issue _from oldest to newest_, and close them if __all of the
  following are true__:
...
- Leave a message when closing saying "Cleaning up stale issue. Please reopen
  ...
  https://github.com/choojs/choo/blob/latest/CONTRIBUTING.md#clean-up-issues-and-prs
  for more details."
...
PR reviews use [GitHub's own review
feature](https://help.github.com/articles/about-pull-request-reviews/), which
